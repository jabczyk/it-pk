        ...
        <div className="max-w-[1000px] w-full bg-white rounded-md shadow-lg border border-slate-100 overflow-hidden grid grid-cols-1 md:grid-cols-2 min-h-[600px]">
          ...
          <div className="p-8 md:p-12 flex flex-col justify-center bg-white">
            <div className="max-w-sm w-full mx-auto">
              <h2 className="text-2xl font-bold text-[#021124] tracking-tight">Sign In</h2>
              ...
              <form onSubmit={handleSignIn} className="mt-6 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  <div className="flex items-center justify-between">
                    ...
                    <a href="#" className="text-[10px] font-bold text-[#65a30d] hover:text-[#4d7c0f] transition-colors uppercase tracking-wider">
                      Forgot password?
                    </a>
                  </div>
                  <div className="relative">
                ...
                <div className="flex items-center gap-2 mt-1">
                  <input 
                    id="remember"
                    type="checkbox"
                    className="w-3.5 h-3.5 border-slate-300 rounded text-[#021124] focus:ring-[#021124]"
                  />
                  <label htmlFor="remember" className="text-[11px] text-slate-500 font-medium select-none">
                ...
                <button 
                  type="submit" 
                  disabled={loading}
                  className="mt-2 w-full bg-[#021124] hover:bg-[#0f172a] active:bg-[#021124] disabled:bg-slate-300 disabled:cursor-not-allowed text-white py-2.5 px-4 font-bold text-xs rounded-sm transition-all shadow-sm flex items-center justify-center gap-2 uppercase tracking-widest"
                >
                  {loading ? (
                    <>
              ...
              <div className="mt-8 text-center">
                ...
                <Link to="/register" className="text-xs font-bold text-[#65a30d] hover:text-[#4d7c0f] transition-colors">
                  Create an account
                </Link>
              </div>
            </div>
